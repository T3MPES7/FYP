...
#intialize logging capabilities
import logging
from pythonjsonlogger import jsonlogger

#Central Logging Configuration
class JsonFormatter(jsonlogger.JsonFormatter):
    def JsonFields(self, log_record, record, message_dict):
        super(JsonFormatter, self).JsonFields(log_record, record, message_dict)
        
        # timestamp. Otherwise
        sim_time = getattr(record, 'env_time', None)
        log_record['timestamp'] = sim_time  
		
        #log level and module name
...
#file handler
log_handler = logging.FileHandler('MercuryLogs.json')
